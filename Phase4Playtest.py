...
def setup_playtest():
    ...
    weather_class = unreal.EditorAssetLibrary.load_blueprint_class('/Script/MegaregionSim.MegaregionWeatherSystem')
    if weather_class:
    ...
    track_gen_class = unreal.EditorAssetLibrary.load_blueprint_class('/Script/MegaregionSim.TrackGenerator')
    if track_gen_class:
    ...
    train_class = unreal.EditorAssetLibrary.load_blueprint_class('/Script/MegaregionSim.TrainPawn')
    if train_class:
